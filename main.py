...
class KnowledgeAssistant:
    ...
    def print_welcome(self):
        ...
        print("   🆓 FREE Groq API + FAISS + Token Optimization")
        print("=" * 70)
        print()
        print("This system will:")
        print("📥 1. Ingest documentation from web sources")
        print("🧠 2. Build optimized vector database for Q&A")
        print("💬 3. Answer your questions using Groq AI (FREE!)")
        print()
        print("🔧 Technology Stack:")
        print("  📊 Vector Store: FAISS with persistent storage")
        print("  🧠 Embeddings: SentenceTransformers (all-MiniLM-L6-v2)")
        print("  🤖 LLM: Groq Llama-3.1-8B (FREE & FAST!)")
        print("  🔤 Token Optimization: 4-step pipeline for FREE tier")
        print("  💰 Cost: $0.00 - Completely FREE!")
        print()
        print("🔍 Grounded answers only - if information isn't in the docs,")
